...
// tape.only('Future observers receive the current/last value in the signal', t => {
//   t.plan(1)
//
//   const expected = { payload: 'world' }
//   const signal = Signal.of('hello')
//   signal.register((type, payload) => payload)
//   signal.emit({ payload: 'bitches' })
//   // signal.observe(state => {
//   //   console.log('This should be the initial state', state)
//   //   console.log('And will this fire twice?')
//   // })
//
//   setTimeout(() => {
//     signal.observe(state => {
//       console.log('1. Future state', state)
//     })
//     signal.emit({ payload: 'world' })
//
//     setTimeout(() => {
//       signal.observe(state => {
//         console.log('2. Future state', state)
//         t.deepEqual(state, expected, 'Observer receives the current state')
//       })
//     }, 10)
//   }, 10)
// })
